...
<div class="container">
  <div class="row">
    ...
    <div class="col-12 col-sm-9">
      ...
      <input type="text" class="form-control" name = "un" id="un" placeholder="Enter Unique UserName" onkeyup="checkUN()">
      ...
      <input type="password" class="form-control" name = "Cpass" id="Cpass" onblur="checkCpass()" placeholder="Retype Pasword">
      <span id="CpassErr" class="text-danger font-weight-bold"></span>
