...
function nidvalidation(e) {
    if (document.getElementById('nid').value == "") {
        document.getElementById('validatenid').innerHTML = "Card is required";
        console.log("1");
    }
    else if (document.getElementById('nid').value.length < 16) {
        document.getElementById('validatenid').innerHTML = "Card is invalid";
    }
    else {
...
function nnidvalidation(e) {
    if (document.getElementById('nnid').value == "") {
        document.getElementById('validatennid').innerHTML = "CVC code is required";
    }
    else if (document.getElementById('nnid').value.length < 4) {
        document.getElementById('validatennid').innerHTML = "CVC code is invalid";
    }
    else {
