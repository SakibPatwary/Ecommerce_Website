...
<div style="    width:800px;     margin:0 auto;    padding: 16px;    background-color: white;    border: 5px solid #050308;">
        ...
        <div style="text-align: center;">
            <img src="eLogo.png" alt="XYZ" width="150" height="150"><br>
            <h1>Sign Up</h1>
        </div>
    ...
    <form action=""  method="post" enctype="multipart/form-data">
        ...
        <span style="color: red" id="validatenid">Card is required</span>
        <br>
        <br>

        <label for="nnid">CVC code: </label>
        <input type="text" id="nnid" name="nnid">
        <span style="color: red" id="validatennid">CVC code is required</span>
