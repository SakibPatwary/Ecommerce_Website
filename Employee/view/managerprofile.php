<?php
    ...
    $sql = "SELECT * FROM managertable WHERE email = '".$_REQUEST['email']."'";
...
<body>
    <div>
        ...
        <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);  max-width: 300px;  margin: auto;  text-align: center;  font-family: arial;">
            <img src="../../Admin/img/<?php echo $email?>.jpg" alt="<?php echo $name?>" style="width:30%">
            ...
            <p style="border: 2px solid black; background-color: black; padding: 5px; width: 200px; margin: auto;"><a style="color: white;"  href='../control/deletemanageraccount.php?email=<?php echo $email?>&status=<?php echo $status?>'>Delete/Active Account</a></p>
        </div>
